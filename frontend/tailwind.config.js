  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'linear-gradient(135deg, rgba(16, 185, 129, 0.08) 0%, transparent 50%, rgba(6, 182, 212, 0.06) 100%)',
      ...
      boxShadow: {
        ...
        'glow-lg': '0 0 50px -12px rgba(16, 185, 129, 0.25)',
        'glow-xl': '0 0 80px -15px rgba(16, 185, 129, 0.3)',
